...
validates_numericality_of :nota, :greater_than_or_equal => 0, :less_than_or_equal_to => 10
validates_numericality_of :valor_gasto, :greater_than_or_equal => 0, :message => " - deve ser um numero maior que 0"
end
